...
\lhead{
  \includegraphics[height=0.6in,trim=-5 -5 -5 -5]{logo-uw}\\
  \includegraphics[height=0.6in,trim=-10 -10 -10 -10]{logo-scan}
}

\chead{
  \includegraphics[height=1.25in,trim=350 0 0 0]{logo-sfs}
}
